...
var createScene = function () {
    ...
    // Load hero character
    BABYLON.SceneLoader.ImportMesh("", "https://raw.githubusercontent.com/godishalagoutham/babylonJs/main/", "finaltry.glb", scene, function (newMeshes, particleSystems, skeletons, animationGroups) {
        var hero = newMeshes[0];

        //Scale the model down        
        hero.scaling.scaleInPlace(0.9);
        ...
        const walkAnim = scene.getAnimationGroupByName("forward");
        const walkBackAnim = scene.getAnimationGroupByName("bk");
